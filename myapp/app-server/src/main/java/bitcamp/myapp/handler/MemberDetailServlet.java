  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if (member == null) {
      ...
      out.printf("<tr><th style='width:120px;'>사진</th>"
          ...
          "<a href='https://kr.object.ncloudstorage.com/bitcamp-nc7-bucket-01/member/%s'>"
              + "<img src='http://xxqrmvmzbxkt19010716.cdn.ntruss.com/member/%1$s?type=f&w=60&h=80&faceopt=true&ttype=jpg'>"
              + "</a>")
