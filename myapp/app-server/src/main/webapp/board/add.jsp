...
<form action='/board/update.jsp' method='post' enctype='multipart/form-data'>
    ...
    <table border='1'>
        <tr>
            ...
            <td style='width:300px;'><input type='text' name='no' value='<%=board.getNo()%>'
                                            readonly></td>
        </tr>
        <tr>
            <th>제목</th>
        ...
        <tr>
            ...
            <td><textarea name='content'
                          style='height:200px; width:400px;'><%=board.getContent()%></textarea></td>
        </tr>
        <tr>
            <th>작성자</th>
        ...
        <tr>
            <th>등록일</th>
            <td><%=String.format("%tY-%1$tm-%1$td", board.getCreatedDate())%>
            </td>
        </tr>
        <tr>
            <th>첨부파일</th>
            <td>
                ...
                %>
                <a href='https://kr.object.ncloudstorage.com/bitcamp-nc7-bucket-01/board/<%=file.getFilePath()%>'><%=file.getFilePath()%>
                </a>
                [<a href='/board/file/delete.jsp?category=<%=category%>&no=<%=file.getNo()%>'>삭제</a>]
                <br>
                <%
                    }
                %>
    ...
    <div>
        ...
        <a href='/board/?category=<%=board.getCategory()%>&no=<%=board.getNo()%>'>삭제</a>
        <a href='/board/fileDelete.jsp?category=<%=board.getCategory()%>'>목록</a>
    </div>
</form>
<%
        try {
