...
public class Servlet08 extends GenericServlet {
  ...
  public void service(ServletRequest req, ServletResponse res)
    ...
    thumbnailBuilder2.size(36, 36);
    thumbnailBuilder2.crop(Positions.CENTER);
    thumbnailBuilder2.outputFormat("png");
    ...
    out.printf("사진=%s<br>\n", filename);
    out.printf("<img src='../upload/thumbnail.%s.png'><br>\n", filename);
    out.printf("<img src='../upload/%s_36x36.png'><br>\n", filename);
    out.printf("<img src='../upload/%s_80x80.png'><br>\n", filename);
    out.printf("<img src='../upload/%s' height='80'><br>\n", filename);
    out.printf("<img src='../upload/%s_160x160.png'><br>\n", filename);
